...
public class LightSwitch : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DayNear = DayNear.OrderBy(t2d => t2d.name, new StaticObject<string>()).ToArray();
        DayFar = DayFar.OrderBy(t2d => t2d.name, new StaticObject<string>()).ToArray();
        NightNear = NightNear.OrderBy(t2d => t2d.name, new StaticObject<string>()).ToArray();
        NightFar = NightFar.OrderBy(t2d => t2d.name, new StaticObject<string>()).ToArray();
